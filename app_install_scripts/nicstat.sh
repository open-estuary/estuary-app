...
function compile_and_install()
{
	...
	if [ "$DISTRIBUTION"x == "Debian"x ] ; then
		...
		rm -rf nicstat-1.95-10.fc29.aarch64.rpm
		wget http://www.rpmfind.net/linux/fedora/linux/releases/29/Everything/aarch64/os/Packages/n/nicstat-1.95-10.fc29.aarch64.rpm
		ass_rst $? 0 "wget nicstat-1.95-10.fc29.aarch64.rpm failed!"

		rpm -i nicstat-1.95-10.fc29.aarch64.rpm
		ass_rst $? 0 "install nicstat-1.95-10.fc29.aarch64.rpm failed!"
