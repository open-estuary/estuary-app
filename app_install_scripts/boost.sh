...
## name:	boost
## desc:	boost c++ lib source code build and install
...
## Selfdef Varis
#MY_SRC_DIR="boost-boost-1.63.0"
#MY_SRC_TAR="boost-1.63.0.tar.gz"
MY_SRC_DIR="boost_1_63_0"
MY_SRC_TAR="boost_1_63_0.tar.bz2"
