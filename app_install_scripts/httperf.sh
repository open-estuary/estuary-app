...
function compile_and_install()
{
	...
	if [ "$DISTRIBUTION"x == "Debian"x ] ; then
		...
		#yum --setopt=skip_missing_names_on_install=False install -y httperf
		wget -O httperf-0.9.0-22.fc29.aarch64.rpm http://www.rpmfind.net/linux/fedora/linux/releases/29/Everything/aarch64/os/Packages/h/httperf-0.9.0-22.fc29.aarch64.rpm
		yum install -y httperf-0.9.0-22.fc29.aarch64.rpm
		rm -rf httperf-0.9.0-22.fc29.aarch64.rpm
		pr_ok "[compile]<install> ok"
	fi
