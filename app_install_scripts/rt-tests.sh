...
{
	wget -O rt-tests.tar.gz https://git.kernel.org/pub/scm/utils/rt-tests/rt-tests.git/snapshot/rt-tests-1.0.tar.gz
	ass_rst $? 0 "wget failed"

	tar xvf rt-tests.tar.gz
	cd rt-tests-1.0
	ass_rst $? 0 "cd rt-tests-1.0/ failed"
