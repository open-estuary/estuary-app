...
## name:	gtest
## desc:	google test source code compile and install
...
SRC_URL="https://github.com/google/googletest/archive/release-1.8.1.tar.gz"
PKG_URL=NULL
DISTRIBUTION=NULL
rst=0

## Selfdef Varis
MY_SRC_DIR="googletest-release-1.8.1"
MY_SRC_TAR="release-1.8.1.tar.gz"
